        ...
        if(strcmp(password, "inertia")==0){
            ...
            do{
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    ...
                    cout<<"I'm a virtual assistant created by Algo Messihas !!!"<<endl;
                    string phrase = "I am a virtual assistant created by Algo Messihas";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                    ...
                    cout<<"I'm good sir,what about you.."<<endl;
                    string phrase = "I'm good sir,what about you..";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                else if(strcmp(ch, "open hackerrank") == 0){
                    cout<<"openining hackerrank....."<<endl;
                    string phrase = "opening hackerrank";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
